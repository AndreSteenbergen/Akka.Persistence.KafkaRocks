...
{
    public class KafkaRocksReadJournal : 
        IReadJournal,
        ...
        ICurrentEventsByTagQuery
    {
        ...
        {
            return ConfigurationFactory.FromResource<KafkaRocksReadJournal>("Akka.Persistence.RocksDb.reference.conf");
        }

        public KafkaRocksReadJournal(ExtendedActorSystem system, Config config)
        {
